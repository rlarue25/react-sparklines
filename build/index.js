...
exports.SparklinesSpotsMinMax = exports.SparklinesText = exports.SparklinesNormalBand = exports.SparklinesReferenceLine = exports.SparklinesSpots = exports.SparklinesBars = exports.SparklinesCurve = exports.SparklinesLine = exports.Sparklines = undefined;
...
exports.SparklinesSpotsMinMax = _SparklinesSpotsMinMax2.default;
...
var SparklinesSpotsMinMax = function (_React$Component) {
    _inherits(SparklinesSpotsMinMax, _React$Component);

    function SparklinesSpotsMinMax() {
        _classCallCheck(this, SparklinesSpotsMinMax);

        return _possibleConstructorReturn(this, (SparklinesSpotsMinMax.__proto__ || Object.getPrototypeOf(SparklinesSpotsMinMax)).apply(this, arguments));
    }

    _createClass(SparklinesSpotsMinMax, [{
        key: 'getIndex',
        value: function getIndex(data) {
            var minIndex = data.indexOf(Math.min.apply(Math, data));
            var maxIndex = data.indexOf(Math.max.apply(Math, data));
        ...
        value: function render() {
            ...
            var minSpot = _react2.default.createElement('circle', {
                cx: points[minIndex].x,
                cy: points[minIndex].y,
                r: size,
    ...
    return SparklinesSpotsMinMax;
}(_react2.default.Component);

SparklinesSpotsMinMax.propTypes = {
    size: _propTypes2.default.number,
    style: _propTypes2.default.object
};
SparklinesSpotsMinMax.defaultProps = {
    size: 2
};
